...
// DeepVision attendance device:
// 1. Connects ESP32 to WiFi.
// 2. Searches the GT5X fingerprint database.
// 3. Sends matched attendance events to Google Apps Script / Google Sheets.
...
// GT5X fingerprint sensor serial connection: ESP32 RX=16, TX=17.
